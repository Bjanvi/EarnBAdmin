...
class JobCollectionRecord extends FirestoreRecord {
  ...
  // "jobRoleRef" field.
  List<DocumentReference>? _jobRoleRef;
  List<DocumentReference> get jobRoleRef => _jobRoleRef ?? const [];
  ...
  void _initializeFields() {
    ...
    _jobRoleRef = getDataList(snapshotData['jobRoleRef']);
  }
...
class JobCollectionRecordDocumentEquality
  ...
  bool equals(JobCollectionRecord? e1, JobCollectionRecord? e2) {
    ...
    return e1?.jId == e2?.jId &&
        ...
        listEquality.equals(e1?.jobRoleRef, e2?.jobRoleRef);
  }
